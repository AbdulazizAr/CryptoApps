...
function encryptAES(plaintext, key) {
  ...
  console.log("After initial AddRoundKey:", bytesToHexString(state)); // Check here
  ...
  for (let round = 1; round <= 10; round++) {
    ...
    console.log("After SubBytes:", bytesToHexString(state)); // Check here
    aesState.rounds[round].subBytes = [...state];

    // ShiftRows
    state = shiftRows(state);
    console.log("After ShiftRows:", bytesToHexString(state)); // Check here
    aesState.rounds[round].shiftRows = [...state];

    // MixColumns
    if (round < 10) {
      state = mixColumns(state);
      console.log("After MixColumns:", bytesToHexString(state)); // Check here
    ...
    console.log("After AddRoundKey:", bytesToHexString(state)); // Check here
    aesState.rounds[round].addRoundKey = [...state];
  }

  console.log("Final Result:", bytesToHexString(state)); // Check here
